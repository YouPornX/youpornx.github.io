...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=373237');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "373237");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "502bbe04fd444c55812f566a368cb454bc37bb0eff391696a29cf81c58a5458a");
define('CREATED_TIMESTAMP', "1758553506");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor373237');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor373237');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "youpornx.github.io",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "youpornx.github.io",
));
